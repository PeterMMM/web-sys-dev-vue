  ...
  <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Code with Vue!</h2>
        <p class="mt-6 text-lg leading-8 text-gray-300">Welcome to LAP Vue!</p>
      </div>
...
const links = [
  { name: 'Learn Vue', href: '#' },
  { name: 'Join LAP Web System Couse', href: '#' },
  { name: 'View Teacher Info', href: '#' },
  { name: "Meet Students\'s community ", href: '#' },
]
const stats = [
  { name: '20+ Student', value: '20' },
  { name: 'Learning Hours', value: '300+' },
  { name: 'Coding Time', value: '40+' },
  { name: 'Excitment', value: 'Unlimited' },
]
</script>